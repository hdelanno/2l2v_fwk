...
runProcess = cms.PSet(
    ...
    input = cms.untracked.vstring("dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/VBF_HToZZTo2L2Nu_M600_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/80000/2AF166D9-DE33-E511-9728-002590D9D8C2.root",
),
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/CompaCinematique/results/MC13TeV_VBFtoH600toZZto2L2Nu_powheg15_9.root"),
    isMC = cms.bool(True),
