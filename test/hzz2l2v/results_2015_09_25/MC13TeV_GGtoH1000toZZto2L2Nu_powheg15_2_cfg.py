...
runProcess = cms.PSet(
    ...
    input = cms.untracked.vstring("dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/GluGluHToZZTo2L2Nu_M1000_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/30000/C61DC71D-2D32-E511-821B-00259073E3A0.root",
"dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/GluGluHToZZTo2L2Nu_M1000_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/30000/CC397550-DD33-E511-A149-0CC47A4DEE1C.root",
),
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/hzz2l2v/results_2015_09_25/MC13TeV_GGtoH1000toZZto2L2Nu_powheg15_2.root"),
    isMC = cms.bool(True),
