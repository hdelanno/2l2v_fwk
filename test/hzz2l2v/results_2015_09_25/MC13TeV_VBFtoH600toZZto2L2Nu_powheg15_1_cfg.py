...
runProcess = cms.PSet(
    ...
    input = cms.untracked.vstring("dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/VBF_HToZZTo2L2Nu_M600_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/40000/5419B8D0-8632-E511-8183-20CF3027A565.root",
"dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/VBF_HToZZTo2L2Nu_M600_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/40000/9816C438-E433-E511-B032-003048FFD75C.root",
    ...
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/hzz2l2v/results_2015_09_25/MC13TeV_VBFtoH600toZZto2L2Nu_powheg15_1.root"),
    isMC = cms.bool(True),
