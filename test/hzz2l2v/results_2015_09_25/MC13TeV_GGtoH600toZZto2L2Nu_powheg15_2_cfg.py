...
runProcess = cms.PSet(
    ...
    input = cms.untracked.vstring("dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/GluGluHToZZTo2L2Nu_M600_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/20000/447B7207-4C34-E511-BB0A-842B2B182385.root",
"dcap://maite.iihe.ac.be:/pnfs/iihe/cms/ph/sc4/store/mc/RunIISpring15DR74/GluGluHToZZTo2L2Nu_M600_13TeV_powheg_JHUgen_pythia8/MINIAODSIM/Asympt25ns_MCRUN2_74_V9-v1/20000/7441CAA4-4C34-E511-849E-0025905C42A8.root",
),
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/hzz2l2v/results_2015_09_25/MC13TeV_GGtoH600toZZto2L2Nu_powheg15_2.root"),
    isMC = cms.bool(True),
