...
runProcess = cms.PSet(
    ...
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/CompaCinematique/results/MC13TeV_VBFtoH600toZZto2L2Nu_powheg15_16.root"),
    isMC = cms.bool(True),
