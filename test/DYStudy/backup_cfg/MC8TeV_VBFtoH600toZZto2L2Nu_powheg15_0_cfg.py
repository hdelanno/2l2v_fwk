...
runProcess = cms.PSet(
    dtag  = cms.string("MC8TeV_VBFtoH600toZZto2L2Nu_powheg15"),
    input = cms.untracked.vstring("file:///localgrid/delannoy/HZZ2L2NU/PUJetID/Alessio_HZZ2L2NU_8TeV/VBF_2l2nu_Powheg_JHUgen_Pythia8_MCRUN2_74_V9.root",
),
    outfile = cms.string("/grid_mnt/storage__localgrid/delannoy/HZZ2L2NU/PUJetID/CompaCinematique/CMSSW_7_4_4/src/UserCode/llvv_fwk/test/CompaCinematique/results/MC8TeV_VBFtoH600toZZto2L2Nu_powheg15_0.root"),
    isMC = cms.bool(True),
